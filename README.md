...
关键词：宇宙云、宇宙云怎么样、宇宙云评测、宇宙云优惠码、VLESS 机场、IEPL 专线、翻墙、科学上网、Clash 节点。

---

## 一句话结论

宇宙云是一家 **VLESS + IEPL 专线机场**，主打**不限速、不限设备、支持流量重置**，档位从低到高非常连续，适合"想要专线规格、又希望按用量精确选档"的中重度用户。综合评分 **9.2**，优惠码 **`YUZHOU553`**。
...
- **VLESS**：VMess 精简版协议，配合 TLS 传输开销小、抗封锁强、延迟低，目前主流专线协议；
- **IEPL 专线**：跨境走内网专线、不经公网 GFW，晚高峰不受公网拥塞与 QoS 限速影响。
...
| 套餐 | 价格 | 流量 | 适合谁 |
| :-- | :-- | :-- | :-- |
| 星云年付小包 | 折合 ¥8/月（仅年付） | 60GB/月 | 低预算长期，愿意年付 |
| **行星基础版（主推）** | **¥25/月** | **120GB** | **日常标准档** |
| 恒星标准版 | ¥50/月 | 240GB | 中量用户 |
| 星系专业版 | ¥100/月 | 500GB | 重度用户 |
| 寰宇旗舰版 | ¥200/月 | 1TB | 超大流量 |

（行星基础版另有年付 ¥230 / 季付 ¥70 / 半年付 ¥130。）结算填优惠码 **`YUZHOU553`**。

> 注意：星云年付小包只有年付，月付起步是 ¥25 档。
...
**适合**：要专线线路、看重晚高峰稳定、希望档位灵活可升级的中重度用户；多设备 / 用量波动大、需要流量重置；愿意自测 AI 的人。

**不太适合**：AI 重度且不想自测、要现成全解锁保证的人（选二猫云更稳）；只要最低价的省钱党。
